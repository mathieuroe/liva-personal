...
const LEISTUNGEN: Leistung[] = [
  ...
  },
  {
    id: "hausnotruf",
    name: "Hausnotruf",
    betrag: "25,50 € / Monat Zuschuss",
    beschreibung: "Die Pflegekasse zahlt monatlich 25,50 € für ein Hausnotruf-System. Bei günstigen Anbietern entstehen keine Kosten.",
    pflegegrade: [1, 2, 3, 4, 5],
    icon: "🔔",
    antragsSchritte: [
