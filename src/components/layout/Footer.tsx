  ...
  return (
    <footer className="bg-gray-950 text-white mt-24">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        <div className="flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 text-sm text-gray-400">
            <div className="flex flex-col gap-2.5">
              <p className="text-gray-600 text-xs uppercase tracking-wider font-semibold mb-1">Navigation</p>
            ...
            <div className="flex flex-col gap-2.5">
              <p className="text-gray-600 text-xs uppercase tracking-wider font-semibold mb-1">Leistungen</p>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-xs text-gray-600">
