...
const LEISTUNGEN = [
  ...
  { id: "hausnotruf", icon: "🔔", name: "Hausnotruf", betrag: "ab 0 € / Monat", pg: "Ab PG 1", featured: true, text: "Ein Knopfdruck – sofort antwortet jemand. Gibt Sicherheit wenn man kurz weg muss. Pflegekasse zahlt 25,50 € / Monat Zuschuss – bei günstigen Anbietern entstehen keine Kosten." },
