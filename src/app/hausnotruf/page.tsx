...
export const metadata: Metadata = {
  ...
  description: "Die Pflegekasse zahlt 25,50 € pro Monat für deinen Hausnotruf. Bei vielen Anbietern entstehen keine Kosten für dich.",
};
        ...
        <section className="bg-white py-16 px-4 sm:px-6 border-b border-[#E0EDE7]">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-6">Die Pflegekasse zahlt 25,50 € pro Monat für ein Hausnotruf-System. Bei günstigen Anbietern entstehen für dich keine Kosten.</p>
            ...
            <div className="flex justify-center">
              <div className="bg-brand-light rounded-[20px] p-8 text-center w-full max-w-sm">
                ...
                <p className="font-serif text-3xl text-brand mb-1">25,50 € / Monat</p>
